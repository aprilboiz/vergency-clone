...
<header>
    ...
    <div class="header__items center">
        ...
        <?php 
            if (!isAnyLogged()){
                echo '<a href="./account/login.php"><ion-icon class="icon" name="person"></ion-icon></a>';
            }else{
...
<script>
    function isOnScreen(element) {
        ...
        return (curPos.bottom < 0) ? false : true;
    }
    ...
    search_box.addEventListener("keydown", function(e){
        if (e.code == "Enter"){
            let search_q = search_box.value;
            window.location = "./search.php?q="+search_q+"&sort=asc&type=all";
        }
    })
